...
@ExchangeAnnotation
public class Poliniex extends Exchange implements Serializable, ExchangeInterface {
	...
	public Poliniex() {
		super();
		enumExchange = EnumExchange.POLONIEX;
		mapper = new ObjectMapper();
		consumidor = new ConsumerThread("https://poloniex.com/public?command=returnTicker", 5000, null);
		consumidor.start();
	}
